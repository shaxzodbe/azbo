                            ...
                            <div class="flex-grow-1 overflow--hidden minw-0">
                                ...
                                <div class="">
                                    <?php if(home_base_price($product->id) != home_discounted_base_price($product->id)): ?>
                                        <del class="opacity-60 fs-15"><?php echo e(home_base_price($product->id)); ?></del>
                                    <?php endif; ?>
                                    <span class="fw-600 fs-16 text-primary"><?php echo e(home_discounted_base_price($product->id)); ?></span>
                                </div>
                            </div>
                        </div>
                    </a>
...
<?php endif; ?>
<?php /**PATH /var/www/azbo/resources/views/frontend/partials/search_content.blade.php ENDPATH**/ ?>