        ...
        <div class="container">
            <div class="row gutters-10 position-relative">
                ...
                <div class="<?php if($num_todays_deal > 0): ?> col-lg-7 <?php else: ?> col-lg-9 <?php endif; ?>">
                    ...
                    <?php endif; ?>
                    <?php if(count($featured_categories) > 0): ?>
                        <ul class="list-unstyled mb-0 row gutters-5" style="height:400px;">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="row gutters-5">
                            ...
                            <?php $__currentLoopData = $top10_brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php if($brand != null && $brand->products->count()): ?>
                                    <div class="col-sm-6">
...
<!-- begin WebMoney Transfer : attestation label --> <a href="https://passport.webmoney.ru/asp/certview.asp?wmid=231185321274" target=_blank><IMG SRC="attestated.png" title="Здесь находится аттестат нашего WM идентификатора " border="0"><br><font size=1>Проверить аттестат</font></a> <!-- end WebMoney Transfer : attestation label -->
<!-- end WebMoney Transfer : attestation label --><a href="https://www.webmoney.ru" target="_blank"><img border="0" src="88x31_wm_blue_on_white_ru.png" width="88" height="31"></a><!-- end WebMoney Transfer : accept label -->
<!-- webmoney passport label#A93350D0-E0EA-4D90-91F1-07595D9BD2E9 begin -->
<a href="//passport.webmoney.ru/asp/certview.asp?wmid=231185321274">
<img src="https://files.webmoney.ru/files/5xtc9oj4/inline" border="0"/>
</a> 
<!-- webmoney passport label#A93350D0-E0EA-4D90-91F1-07595D9BD2E9 end -->
<?php $__env->stopSection(); ?>

<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/azbo/resources/views/frontend/index.blade.php ENDPATH**/ ?>