                        ...
                        <table class="table table-responsive table-bordered mb-0">
                                ...
                                <tr>
                                    ...
                                    <?php $__currentLoopData = Session::get('compare'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <th scope="col" style="width:28%" class="font-weight-bold">
                                            <a class="text-reset fs-15" href="<?php echo e(route('product', \App\Product::find($item)->slug)); ?>"><?php echo e(\App\Product::find($item)->getTranslation('name')); ?></a>
                                        </th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <?php $__currentLoopData = Session::get('compare'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <td>
                                            <img loading="lazy" src="<?php echo e(uploaded_asset(\App\Product::find($item)->thumbnail_img)); ?>" alt="<?php echo e(translate('Product Image')); ?>" class="img-fluid py-4">
                                        </td>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tr>
                                <tr>
                                    ...
                                    <?php $__currentLoopData = Session::get('compare'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <td>
                                            <?php if(\App\Product::find($item)->brand != null): ?>
                                                <?php echo e(\App\Product::find($item)->brand->getTranslation('name')); ?>
                                    ...
                                    <?php $__currentLoopData = Session::get('compare'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <td>
                                            <?php if(\App\Product::find($item)->subsubcategory != null): ?>
                                                <?php echo e(\App\Product::find($item)->subsubcategory->getTranslation('name')); ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/azbo/resources/views/frontend/view_compare.blade.php ENDPATH**/ ?>