<a href="javascript:void(0)" class="d-flex align-items-center text-reset h-100" data-toggle="dropdown" data-display="static">
    ...
    <span class="flex-grow-1 ml-1">
        <?php if(Session::has('cart')): ?>
            <span class="badge badge-primary badge-inline badge-pill"><?php echo e(count(Session::get('cart'))); ?></span>
        <?php else: ?>
                    ...
                    <?php if($product != null): ?>
                        <li class="list-group-item">
                            <span class="d-flex align-items-center">
                                ...
                                <span class="">
                                    <button onclick="removeFromCart(<?php echo e($key); ?>)" class="btn btn-sm btn-icon stop-propagation">
            ...
            <div class="px-3 py-2 text-center border-top">
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        ...
                        <a href="<?php echo e(route('my_card')); ?>" class="btn btn-soft-primary btn-sm">
                    ...
                    <li class="list-inline-item">
                       ...
                       <a href="<?php echo e(route('checkout.detail_payment')); ?>" class="btn btn-primary btn-sm">
...
<?php /**PATH /var/www/azbo/resources/views/frontend/partials/cart.blade.php ENDPATH**/ ?>