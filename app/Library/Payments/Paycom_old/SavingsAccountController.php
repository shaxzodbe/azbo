...
class SavingsAccountController extends App\Library\Payments\BaseController
{
    ...
    public function checkAuth()
    {
        ...
        $paycom_user = App\Models\Payment::where('alias', 'payme')->first()->name;
        $paycom_key = App\Models\Payment::where('alias', 'payme')->first()->secret_key;
