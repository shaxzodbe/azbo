...
class BonusProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('backend.product.bonus_products.index', compact('products', 'type', 'col_name', 'query', 'sort_search'));
    }
    ...
    public function create()
    {
        ...
        return view('backend.product.bonus_products.create', compact('categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if (Auth::user()->user_type == 'admin' || Auth::user()->user_type == 'staff') {
            return redirect()->route('bonus_products.index');
        } else {
    ...
    public function admin_product_edit(Request $request, $id)
    {
        ...
        return view('backend.product.bonus_products.edit', compact('product', 'categories', 'tags', 'lang'));
    }
