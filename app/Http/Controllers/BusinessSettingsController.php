...
class BusinessSettingsController extends Controller
{
    ...
    /**
     * Monthly payment method update
     * Created by ouarka.dev@gmail.com  
     * 
     * 
     */
    public function monthly_payment_update(Request $request) {
        if ($request->type == 'alif_bank_fee') {
            $business_settings = BusinessSetting::where('type', 'alif_bank_fee')->first();
            
            $business_settings->value = $request->alif_bank_fee; 
            $business_settings->save();
        } elseif($request->type == 'alif_instalments') {
            $instalments = [
                [
                    'id' => 1,
                    'label' => '1 month',
                    'name' => 'one_month', 
                    'value' => $request->one_month,
                    'name_active' => 'one_month_active',
                    'active' => $request->one_month_active ? true: false,
                    'period' => 1
                ],
                [
                    'id' => 2,
                    'label' => '3 months',
                    'name' => 'three_months',
                    'value' => $request->three_months,
                    'name_active' => 'three_months_active',
                    'active' => $request->three_months_active ? true : false,
                    'period' => 3,  
                ],
                [
                    'id' => 3,
                    'label' => '6 months',
                    'name' => 'sex_months',
                    'value' => $request->sex_months,
                    'name_active' => 'sex_months_active', 
                    'active' => $request->sex_months_active ? true : false,
                    'period' => 6 
                ],
                [
                    'id' => 4,
                    'label' => '9 months',
                    'name' => 'nine_months', 
                    'value' => $request->nine_months,
                    'name_active' => 'nine_months_active',
                    'active' => $request->nine_months_active ? true : false,
                    'period' => 9,  
                ],
                [
                    'id' => 5,
                    'label' => '12 months',
                    'name' => 'twelve_months',
                    'value' => $request->twelve_months,
                    'name_active' => 'twelve_months_active',
                    'active' => $request->twelve_months_active ? true : false,
                    'period' => 12  
                ],
                [
                    'id' => 6,
                    'label' => '15 months',
                    'name' => 'fifteen_months',
                    'value' => $request->fifteen_months,
                    'name_active' => 'fifteen_months_active',
                    'active' => $request->fifteen_months_active ? true : false,
                    'period' => 15  
                ],
                [
                    'id' => 7,
                    ...
                    'value' => $request->eighteen_months,
                    'name_active' => 'eighteen_months_active',
                    'active' => $request->eighteen_months_active ? true : false,
                    'period' => 18 
                ],
            ];
            
        
            $business_settings = BusinessSetting::where('type', 'alif_instalments')->first();
            $business_settings->value = json_encode($instalments, JSON_NUMERIC_CHECK); 
            $business_settings->save();
        }
