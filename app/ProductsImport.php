...
class ProductsImport implements ToModel, WithHeadingRow, WithValidation
{
    ...
    public function __construct() {
        $this->added_by = Auth::user()->user_type == 'seller' ? 'seller' : 'admin';
        $this->user_id =  Auth::user()->user_type == 'seller' ? Auth::user()->id : User::where('user_type', 'admin')->first()->id;
    }
    ...
    public function model(array $row)
    {
        ...
        return new Product([
           ...
           'thumbnail_img' => $row['thumbnail_img'], // $this->downloadThumbnail($row['thumbnail_img']),
        ]);
    }
