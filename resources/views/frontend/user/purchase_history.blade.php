                                ...
                                <tbody>
                                    ...
                                    @foreach($applications as $key => $application) 
                                        <tr>
                                            ...
                                            <td>{{ single_price($application->price) }} </td>
                                            <td>-</td>
                                            <td>
                                                @if ($application->status == 'approved')
                                                    <span class="badge badge-inline badge-success">{{translate($application->status)}}</span>
                                                @else
                                                    <span class="badge badge-inline badge-danger">{{translate($application->status)}}</span>
                                                @endif
