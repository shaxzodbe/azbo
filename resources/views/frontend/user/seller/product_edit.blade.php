                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row" id="category">
                                    ...
                                    <div class="col-lg-8">
                                        <select class="form-control aiz-selectpicker" data-live-search="true" name="category_id" id="category_id" data-selected={{ $product->category_id }} required>
                                ...
                                <div class="form-group row" id="brand">
                                    ...
                                    <div class="col-lg-8">
                                        <select class="form-control aiz-selectpicker" data-live-search="true" name="brand_id" id="brand_id">
                                ...
                                {{-- <div class="form-group row">
                                    ...
                                    <div class="col-lg-3">
                                        <select class="form-control aiz-selectpicker" name="tax_type" required>
                                            <option value="amount" @if($product->tax_type == 'amount') "selected"; @endif> >{{translate('Flat')}}</option>
                                            <option value="percent" @if($product->tax_type == 'percent') "selected"; @endif> >{{translate('Percent')}}</option>
                                        </select>
                                    </div>
                                </div> --}}
                                <div class="form-group row">
