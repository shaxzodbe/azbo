        ...
        <div class="sidemnenu mb-3">
            <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
                ...
                @if(Auth::user()->user_type == 'seller')
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{route('product_price_bulk_upload.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['product_price_bulk_upload.index'])}}">
                            <i class="las la-upload aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ translate('Product Price Bulk Upload') }}</span>
                        </a>
                    </li>
