                                        ...
                                        <tbody>
                                            @foreach ($order->orderDetails as $key => $orderDetail)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ get_variant_string($orderDetail->variation) }}
                                                    </td>
                                                    <td>
                                        ...
                                        <table class="table ">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <span class="font-italic">{{ /*single_price($order->orderDetails->sum('shipping_cost'))*/ 20000  }}</span>
                                                    </td>
                                                </tr>
                                                {{-- <tr>
                                                    <th>{{ translate('Tax')}}</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <strong><span>{{ single_price($order->orderDetails->sum('price') + 20000) }}</span></strong>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
