                                ...
                                <div class="col-xxl-8 col-xl-10 mx-auto">
                                    <div class="row gutters-10">
                                        @if(\App\BusinessSetting::where('type', 'paysys_payment')->first()->value == 1)
                                            <div class="col-6 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                                    <input value="paysys" class="online_payment" type="radio" name="payment_option" checked>
                                                    <span class="d-block p-3 aiz-megabox-elem">
                                                        <img src="{{ static_asset('assets/img/cards/paysys_logo.png')}}" class="img-fluid mb-2">
                                                        <span class="d-block text-center">
                                                            <span class="d-block fw-600 fs-15">{{ translate('PaySys')}}</span>
                                                        </span>
                                                    </span>
                                                </label>
                                            </div>
                                        ...
                                        @if(\App\BusinessSetting::where('type', 'paycom_payment')->first()->value == 1)
                                            <div class="col-6 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                                    <input value="paycom" class="online_payment" type="radio" name="payment_option" checked>
                                                    <span class="d-block p-3 aiz-megabox-elem">
                                                        <img src="{{ static_asset('assets/img/cards/payme.png')}}" class="img-fluid mb-2">
                                                        <span class="d-block text-center">
                                                            <span class="d-block fw-600 fs-15">{{ translate('Paycom')}}</span>
                                                        </span>
                                                    </span>
                                                </label>
                                            </div>
                            ...
                            @if (Auth::check() && \App\BusinessSetting::where('type', 'wallet_system')->first()->value == 1)
                                ...
                                <div class="pt-3 d-flex justify-content-center">
                                    <label class="aiz-checkbox">
                                        ...
                                        <span style="font-weight: 700">{{ translate('I agree to the')}}</span>
                                    </label>
                                </div>
                                <div class="d-flex justify-content-center">
                                    <a href="{{ route('terms') }}" style="color: #1da1f2">{{ translate('terms and conditions')}}</a>
                                    <a href="{{ route('returnpolicy') }}" style="color: #1cac3d; margin: 0 5%">{{ translate('return policy')}}</a>
                                    <a href="{{ route('privacypolicy') }}" style="color: #16a9c1">{{ translate('privacy policy')}}</a>
                                </div>
                            @endif
                        </div>
                    </div>
