...
<section class="pt-5 mb-4">
  <div class="container  pb-4 pt-md-4 min-vh-80">
      ...
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div>
              <div class="card condition-card {{ $installment->id == $data['selected_installment_id'] ? 'active' : '' }}"
          ...
          <div class="card-footer">
            <button id="btn_next" class="btn btn-primary" style="border-radius: 0px;" onclick="btn_next_clicked()"> {{ translate('Next') }}</button>
          </div>
        </div>
      </div>
              ...
              <li class="list-group-item bg-transparent">
                <div class="row align-items-center">
                  <div class="col-12 col-md-auto">
                    <div class="d-flex justify-content-center"><img src="{{ uploaded_asset($product->thumbnail_img) }}"
                        alt="" class="img-fluid" style="max-height: 100px;"></div>
                  </div>
                  <div class="col">
                    <span class="h6">{{ $product->getTranslation('name')}} - {{ get_variant_string($data['variant']) }} </span>
    ...
    <form action="/application" method="POST" style="display: none;" id="form_next">
      @csrf
