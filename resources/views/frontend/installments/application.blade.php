              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input type="text" name="plastic_serial_number" id="plastic_serial_number" class="form-control"
                    value="{{ Auth::user()->plastic_serial_number }}">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input type="text" name="connected_phone_number" id="connected_phone_number" class="form-control"
                    value="{{ Auth::user()->connected_phone_number }}">
                </div>
              </div>
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <input type="text" name="relative_phone_number1" class="form-control"
                        value="{{ Auth::user()->relative_phone_number1 }}">
                    </div>
                    <div class="col-sm-4">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="relative_phone1_name" id="relative_phone1_name" class="form-control"
                            value="{{ Auth::user()->relative_phone1_name }}">
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="relative_phone1_owner" id="relative_phone1_owner"
                            class="form-control" value="{{ Auth::user()->relative_phone1_owner }}">
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <input type="text" name="relative_phone_number2" id="relative_phone_number2" class="form-control"
                        value="{{ Auth::user()->relative_phone_number2 }}">
                    </div>
                    <div class="col-sm-4">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="relative_phone2_name" id="relative_phone2_name" class="form-control"
                            value="{{ Auth::user()->relative_phone2_name }}">
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="relative_phone2_owner" class="form-control"
                            value="{{ Auth::user()->relative_phone2_owner }}">
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <input type="text" name="relative_phone_number3" id="relative_phone_number3" class="form-control"
                        value="{{ Auth::user()->relative_phone_number3 }}">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="relative_phone3_name" id="relative_phone3_name" class="form-control"
                            value="{{ Auth::user()->relative_phone3_name }}">
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="relative_phone3_owner" class="form-control"
                            value="{{ Auth::user()->relative_phone3_owner }}">
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-sm-5">
                      <input type="text" name="work_place_name" id="work_place_name" class="form-control"
                        value="{{ Auth::user()->work_place_name }}">
                    </div>
                    <div class="col-sm-7">
                      <div class="form-group row">
                ...
                <div class="col-md-1" style="margin-top: auto; margin-bottom: auto;">
                  <label class="aiz-switch aiz-switch-success mb-0">
                    <input type="checkbox" name="is_paying_credit" onchange="amount_credit_changed(this)"
                      @if(Auth::user()->is_paying_credit) checked @endif>
                    <span class="slider round"></span>
                  </label>
                </div>
                <div class="col-md-8">
                  <input type="text" name="amount_credit" id="amount_credit" class="form-control"
                    placeholder="Fill amount here" value="{{ Auth::user()->amount_credit }}"
                    @if(!Auth::user()->is_paying_credit) disabled @endif>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <div class="input-group" data-toggle="aizuploader" data-type="image">
                    ...
                    <input type="hidden" name="passport_image" value="{{ Auth::user()->passport_image }}"
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <div class="input-group" data-toggle="aizuploader" data-type="image">
                    ...
                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                    <input type="hidden" name="photo_with_passport" value="{{ Auth::user()->photo_with_passport }}"
                      class="selected-files">
                  </div>
                  <div class="file-preview box sm">
                  </div>
