                                    ...
                                    <div class="p-3">
                                        <ul class="list-unstyled">
                                            ...
                                            @else
                                                ...
                                                @if($products_count > 0)
                                                <li class="ml-4 mb-2">
                                                    <a class="text-reset fs-14" href="{{ route('products.category', \App\Category::find($id)->slug) }}">{{ $cat->getTranslation('name') }}</a>
                                                </li>
                                                    ...
                                                    @if(array_key_exists('values', $attribute))
                                                        @foreach ($attribute['values'] as $key => $value)
                                                            ...
                                                            <label class="aiz-checkbox">
                                                                ...
                                                                <span>{{ get_variant_string($value) }}</span>
                                                            </label>
                                                        @endforeach
                                                    @endif
                                                </div>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="form-group ml-auto mr-0 w-200px d-none d-xl-block">
                                    ...
                                    <select class="form-control form-control-sm aiz-selectpicker" data-live-search="true" name="vendor" onchange="filter()">
                                        ...
                                        @foreach (\App\Shop::whereHas('user', function($user){
                                                $user->whereHas('seller', function($seller){
                                                    $seller->where('verification_status', 1);
                                                });
                                            })->get() as $shop)
                                            <option value="{{ $shop->user_id }}" @isset($vendor_id) @if ($vendor_id == $shop->user_id) selected @endif @endisset >{{ $shop->name }}</option>
                                        @endforeach
                                ...
                                <div class="col mb-3">
                                    <div class="aiz-card-box h-100 border border-light rounded shadow-sm hov-shadow-md has-transition bg-white">
                                        ...
                                        <div class="p-md-3 p-2 text-left">
                                            ...
                                            <a href="{{route('one_click',['id'=>$product->id])}}"
                                               class="btn btn-primary rounded px-2 mt-2 w-100">
                                                {{--bir klikda olish--}}
                                                {{ trans('intend.bir_klikda_olish') }}
                                            </a>
