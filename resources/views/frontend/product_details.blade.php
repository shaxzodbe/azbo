                                        ...
                                        <div class="btn-toolbar pt-2" role="toolbar" aria-label="Toolbar with button groups">
                                            <div class="btn-group mr-2 installments" role="group" aria-label="First group">
                                                ...
                                                @foreach ($instalments as $k => $instalment)
                                                    <button onclick="changeInstalemnt(this)" data-profit="{{ $detailedProduct->profit }}" data-percent="{{ $instalment->value}}"
                                                            data-installment_id="{{ $instalment->id }}"  data-period="{{$instalment->period}}" style="font-weight: 600" type="button"
...
@section('script')
    <script type="text/javascript">
        ...
        function changeInstalemnt(el) {
            ...
            if (period == 3) {
                $('#select-item-pay').html('<div class="row"><div class="col-md-6 pb-2"><a href="{{ route('get.intent_auth',['id'=>$detailedProduct->id]) }}" class="btn btn-soft-info fw-600 btn-block"><img src="https://azbo.uz/public/assets/img/logo-uzum-nasiya.png" class="h-50px"></a></div><div class="col-md-6 pb-2"><button type="button" class="btn btn-soft-info fw-600 btn-block" onclick="payInInstallments()"><img src="https://azbo.uz/public/uploads/all/rxCNoyRODbRR4P7VfZV82CtaRUC76857ZMfbkgrl.png" class="h-50px" alt=""></button></div>');
            } else if (period == 6) {
                $('#select-item-pay').html('<div class="row"><div class="col-md-6 pb-2"><a href="{{ route('get.intent_auth',['id'=>$detailedProduct->id]) }}" class="btn btn-soft-info fw-600 btn-block"><img src="https://azbo.uz/public/assets/img/logo-uzum-nasiya.png" class="h-50px"></a></div><div class="col-md-6 pb-2"><button type="button" class="btn btn-soft-info fw-600 btn-block" onclick="payInInstallments()"><img src="https://azbo.uz/public/uploads/all/rxCNoyRODbRR4P7VfZV82CtaRUC76857ZMfbkgrl.png" class="h-50px" alt=""></button></div>');
            } else if (period == 12) {
