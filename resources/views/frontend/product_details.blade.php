...
@section('content')
  <div class="col-xl-3 d-xl-block  mt-3 mt-sm-0">
    <div class="i__graphics_company mb-1" style="position: static">
      ...
      <ul class="nav nav-pills mb-3 installment__new-design-ul" id="pills-tab" role="tablist">
        <li class="nav-item" role="presentation">
          <a class="nav-link" id="pills-home-tab" data-toggle="pill" href="#installment_month-13" role="tab" aria-controls="pills-home" aria-selected="false">3 мес. </a>
        </li>
        <li class="nav-item" role="presentation">
          <a class="nav-link" id="pills-home-tab" data-toggle="pill" href="#installment_month-11" role="tab" aria-controls="pills-home" aria-selected="false">6 мес. </a>
        </li>
        <li class="nav-item" role="presentation">
          <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#installment_month-9" role="tab" aria-controls="pills-home" aria-selected="true">12 мес. </a>
        </li>
      </ul>
      <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade" id="installment_month-13" role="tabpanel" aria-labelledby="pills-home-tab">
          <div class="i__month position-relative">
            <input type="radio" name="installment_id_13" id="input-installment-id-13-company-id-15" checked="" value="13">
            <label for="input-installment-id-13-company-id-15">
              <ul>
                <li class="d-flex justify-content-between" style="position: relative ;">
                  <small>Рассрочка от партнера UzumNasiya</small> <img src="/custom-assets/images/icons/info_installment.svg" width="20" height="20" class="img_info-open">
                  <div class="info_installment-partner">
                    <b>Рассрочка от партнера UzumNasiya</b><br>Данный тип рассрочки доступен для зарегистрированных пользователей <b>UzumNasiya</b>                                                        </div>
                </li>
                ...
                <li class="d-flex justify-content-between align-items-center h6 i__month mt-1" style="color: #FE7405;">
                  ...
                  <div class="">
                    <span style="font-weight: bold" class="installment-monthly-graphics mr-1 ">79 600</span>
                    <span style="font-weight: bold">сум</span>

                  </div>
                </li>
              </ul>
              <a href="/cart/checkout-installment?slug=kovrik-dlya-myshi-2e-gaming-pro-speed-xl-d06&amp;installment_id=13&amp;company_id=15" class="btn default-btn btn-orange-custom w-100 text-white mt-2">Заказать в рассрочку</a>
            </label>
          </div>
          <div class="i__month position-relative">
            <input type="radio" name="installment_id_13" id="input-installment-id-13-company-id-6" value="13">
            <label for="input-installment-id-13-company-id-6">
              <ul>
                <li class="d-flex justify-content-between" style="position: relative ;">
                  <small>Рассрочка от Asaxiy</small> <img src="/custom-assets/images/icons/info_installment.svg" width="20" height="20" class="img_info-open">
                  <div class="info_installment-partner">
                    <b>Рассрочка от Asaxiy</b><br>Данный тип рассрочки доступен для зарегистрированных пользователей <b>Asaxiy</b>                                                        </div>
                </li>

                <li class="d-flex justify-content-between align-items-center h6 i__month mt-1" style="color: #FE7405;">
                  <img src="https://asaxiy.uz/custom-assets/images/company/asaxiy.svg" height="30">
                  <div class="">
                    <span style="font-weight: bold" class="installment-monthly-graphics mr-1 ">79 600</span>
                    <span style="font-weight: bold">сум</span>
              ...
              <a href="/cart/checkout-installment?slug=kovrik-dlya-myshi-2e-gaming-pro-speed-xl-d06&amp;installment_id=13&amp;company_id=6" class="btn default-btn btn-orange-custom w-100 text-white mt-2">Заказать в рассрочку</a>
            </label>
          </div>
        </div>
        <div class="tab-pane fade" id="installment_month-11" role="tabpanel" aria-labelledby="pills-home-tab">
          <div class="i__month position-relative">
            <input type="radio" name="installment_id_11" id="input-installment-id-11-company-id-15" checked="" value="11">
            <label for="input-installment-id-11-company-id-15">
              <ul>
                ...
                <li class="d-flex justify-content-between align-items-center h6 i__month mt-1" style="color: #FE7405;">
                  <img src="https://asaxiy.uz/custom-assets/images/company/uzumnasiya.svg" height="30">
                  <div class="">
                    <span style="font-weight: bold" class="installment-monthly-graphics mr-1 ">43 200</span>
                    <span style="font-weight: bold">сум</span>

                  </div>
                </li>
              </ul>
              <a href="/cart/checkout-installment?slug=kovrik-dlya-myshi-2e-gaming-pro-speed-xl-d06&amp;installment_id=11&amp;company_id=15" class="btn default-btn btn-orange-custom w-100 text-white mt-2">Заказать в рассрочку</a>
            </label>
          </div>
          <div class="i__month position-relative">
            <input type="radio" name="installment_id_11" id="input-installment-id-11-company-id-6" value="11">
            <label for="input-installment-id-11-company-id-6">
              ...
              <a href="/cart/checkout-installment?slug=kovrik-dlya-myshi-2e-gaming-pro-speed-xl-d06&amp;installment_id=11&amp;company_id=6" class="btn default-btn btn-orange-custom w-100 text-white mt-2">Заказать в рассрочку</a>
            </label>
          </div>
        </div>
        <div class="tab-pane fade " id="installment_month-14" role="tabpanel" aria-labelledby="pills-home-tab">
        </div>
        <div class="tab-pane fade active show" id="installment_month-9" role="tabpanel" aria-labelledby="pills-home-tab">
          <div class="i__month position-relative">
            ...
            <label for="input-installment-id-9-company-id-15">
              <ul>
                ...
                <li class="d-flex justify-content-between align-items-center h6 i__month mt-1" style="color: #FE7405;">
                  <img src="https://asaxiy.uz/custom-assets/images/company/uzumnasiya.svg" height="30">
                  <div class="">
                    <span style="font-weight: bold" class="installment-monthly-graphics mr-1 ">24 900</span>
                    <span style="font-weight: bold">сум</span>

                  </div>
                </li>
              </ul>
              <a href="/cart/checkout-installment?slug=kovrik-dlya-myshi-2e-gaming-pro-speed-xl-d06&amp;installment_id=9&amp;company_id=15" class="btn default-btn btn-orange-custom w-100 text-white mt-2">Заказать в рассрочку</a>
            </label>
          </div>
          <div class="i__month position-relative">
            <input type="radio" name="installment_id_9" id="input-installment-id-9-company-id-6" value="9">
            <label for="input-installment-id-9-company-id-6">
              ...
              <a href="/cart/checkout-installment?slug=kovrik-dlya-myshi-2e-gaming-pro-speed-xl-d06&amp;installment_id=9&amp;company_id=6" class="btn default-btn btn-orange-custom w-100 text-white mt-2">Заказать в рассрочку</a>
            </label>
          </div>
        </div>
            ...
            <div class="text-left">
              ...
              <form id="option-choice-form">
                ...
                @if ($detailedProduct->choice_options != null)
                  @foreach (json_decode($detailedProduct->choice_options) as $key => $choice)
                    ...
                    <div class="row no-gutters" @if(count($choice->values) == 1) style="display:none" @endif>
              ...
              <div class="mt-3">
                @if ($qty > 0)
                  ...
                  <div class="row">
                    <div class="col-md-6 pb-2">
                      <a href="{{route('one_click',['id'=>$detailedProduct->id])}}"
                         class="btn btn-primary buy-now fw-600  btn-block ">
                        <i class="las la-shopping-cart la-lg"></i>
                        <span
                          class="">{{ trans('intend.bir_klikda_olish') }}</span>
                      </a>
                    </div><!-- /col -->
                    <div class="col-md-6">
                  ...
                  {{--@if(Auth::check())
                      ...
                      @if(\App\BusinessSetting::where('type', 'monthly_payment')->first()->value == 1)
                          ...
                          <a style="color: white;"
                             href="{{ route('get.intent_auth',['id'=>$detailedProduct->id]) }}"
                             type="button" class="btn btn-info fw-600  btn-block"
                             onclick="payInInstallments()"><i class="las la-clock la-lg"></i> {{ translate('Pay in installments') }} </a>
                      @endif
                  @else
                      @if(\App\BusinessSetting::where('type', 'monthly_payment')->first()->value == 1)
                          <button type="button" class="btn btn-info buy-now fw-600"
                ...
                <p style="margin-top: 10px;">
                  <button class="btn btn-info buy-now fw-600 btn-block" type="button" data-toggle="collapse"
                          data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                    <i class="las la-clock la-lg"></i> {{ translate('Pay in installments') }}
                  </button>
                </p>
        ...
        <div class="col-xl-9 order-0 order-xl-1">
          <div class="bg-white mb-3 shadow-sm rounded">
            <div class="nav border-bottom aiz-nav-tabs">
              ...
              @if($detailedProduct->getTranslation('characteristics') != null or $detailedProduct->getTranslation('characteristics') != '')
              ...
              @if (false)
                @foreach (json_decode($detailedProduct->choice_options) as $key => $choice)
                  @if(count($choice->values) == 1)
                    <a href="#attribute_id_{{$choice->attribute_id}}" data-toggle="tab"
                       class="p-3 fs-16 fw-600 text-reset">
            ...
            <div class="tab-content pt-0">
              <div class="tab-pane fade active show" id="tab_default_1">
                <div class="p-4">
                  <div class="mw-100 overflow-hidden text-left">
                      <?php
                      echo $detailedProduct->getTranslation('description'); ?>
                  </div>
                </div>
              </div>
              ...
              @if($detailedProduct->getTranslation('characteristics') != null or $detailedProduct->getTranslation('characteristics') != '')
                <div class="tab-pane fade" id="tab_default_characteristics">
                  <div class="p-4">
                    <div class="aiz-radio-inline">
                      {!! $detailedProduct->getTranslation('characteristics') !!}
              ...
              @if (false)
                @foreach (json_decode($detailedProduct->choice_options) as $key => $choice)
                  @if(count($choice->values) == 1)
                    ...
                    <div class="tab-pane fade" id="attribute_id_{{$choice->attribute_id}}">
                      <div class="p-4">
                        <div class="aiz-radio-inline">
                          @foreach ($choice->values as $key => $value)
                            ...
                            <label class="aiz-megabox pl-0 mr-2">
                              ...
                              <span
                                ...
                                {{-- @if($tata < 6){{ implode('-', $toto[$tata++])}} @endif --}}
                                                        </span>
                            </label>
                          @endforeach
                        </div>
