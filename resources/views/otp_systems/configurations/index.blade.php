            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('update_credentials') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-3">
                            <label class="control-label">{{__('BROKER API USERNAME')}}</label>
                        </div>
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="BROKER_API_USERNAME" value="{{  env('BROKER_API_USERNAME') }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-3">
                            <label class="control-label">{{__('BROKER API PASSWORD')}}</label>
                        </div>
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="BROKER_API_PASSWORD"
                                value="{{  env('BROKER_API_PASSWORD') }}" placeholder="BROKER API PASSWORD" required>
                        </div>
                    </div>
                    <div class="form-group row">
...
<div class="row">
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header">
                <h3 class="mb-0 h6">{{__('Twillo Credential')}}</h3>
            </div>
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('update_credentials') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="TWILIO_VERIFY_SID"
                                value="{{  env('TWILIO_VERIFY_SID') }}" placeholder="TWILIO VERIFY SID">
                        </div>
                    </div>
                    <div class="form-group row">
    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header">
                <h3 class="mb-0 h6">{{__('Nexmo Credential')}}</h3>
            </div>
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('update_credentials') }}" method="POST">
...
<div class="row">
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header">
                <h3 class="mb-0 h6">{{__('SSL Wireless Credential')}}</h3>
            </div>
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('update_credentials') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="SSL_SMS_USER"
                                value="{{  env('SSL_SMS_USER') }}" placeholder="SSL SMS USER" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="SSL_SMS_PASSWORD"
                                value="{{  env('SSL_SMS_PASSWORD') }}" placeholder="SSL SMS PASSWORD">
                        </div>
                    </div>
                    <div class="form-group row">
    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header">
                <h3 class="mb-0 h6">{{__('Fast2SMS Credential')}}</h3>
            </div>
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('update_credentials') }}" method="POST">
