	...
	<div class="row align-items-center">
        ...
        @if($type != 'Seller')
    		<div class="col text-right">
    			<a href="{{ route('bonus_products.create') }}" class="btn btn-circle btn-info">
            ...
            <tbody>
                @foreach($products as $key => $product)
                    <tr>
                        ...
                        <td>
                            <label class="aiz-switch aiz-switch-success mb-0">
                                <input type="checkbox" value={{ $product->id }} <?php if($product->alifshop) echo "checked"; ?> disabled>
                                <span class="slider round"></span>
                            </label>
                        </td>
						<td class="text-right">
							...
							@else
								<a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('bonus_products.edit', ['id'=>$product->id, 'lang'=>env('DEFAULT_LANGUAGE')] )}}" title="{{ translate('Edit') }}">
								   <i class="las la-edit"></i>
							   </a>
							@endif
							<a class="btn btn-soft-success btn-icon btn-circle btn-sm" href="{{route('bonus_products.duplicate', ['id'=>$product->id, 'type'=>$type]  )}}" title="{{ translate('Duplicate') }}"> 
							   <i class="las la-copy"></i>
						   </a>
                           <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('bonus_products.destroy', $product->id)}}" title="{{ translate('Delete') }}">
