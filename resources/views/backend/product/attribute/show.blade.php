...
<div class="row">
		...
		<div class="card">
			...
			<div class="card-body">
				<table class="table aiz-table mb-0">
					...
					<tbody>
						@foreach($parent->children as $key => $attribute)
							<tr>
								<td>{{$key+1}}</td>
	...
	<div class="col-md-5">
		<div class="card">
			<div class="card-header">
					<h5 class="mb-0 h6">Parent Attribute</h5>
			</div>
			<div class="card-body">
							...
							<div class="form-group mb-3">
									...
									<input type="text" readonly value="{{ $parent->getTranslation('name') }}" class="form-control" required>
							</div>
			</div>
		</div>
	</div>
