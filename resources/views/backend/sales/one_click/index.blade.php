...
{{--                    <th data-breakpoints="lg">{{__('intend.toHome')}}</th>
                    ...
                    <th data-breakpoints="lg">{{__('intend.agree_to_buy')}}</th>
                ...
                <tbody>
                @foreach ($one_click_orders as $key => $one_click_order)
                    @if($one_click_order != null)
                        <tr>
                            ...
                            <td>
                                {{ $one_click_order->name }}
                            </td>
                            <td>
                                {{ $one_click_order->phone }}
                            </td>
{{--                            <td>
                                {{ $one_click_order->toHome }}
                            </td>
                            <td>
                                {{ $one_click_order->promo_kod }}
                            </td>--}}
                            <td>
                                {{ $one_click_order->payment_type ? 'Karta orqali onlayn to\'lov' : 'Mahsulotni olganda (naqd)'}}
                            </td>
                            <td>
                                {{ $one_click_order->agree_to_buy ? __('intend.rozilik') : 'rozi emasman'}}
                            </td>
                            <td class="text-right">
                            ...
                            <td>
                                <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                   href="{{ route('one_click_orders.show', encrypt($one_click_order->id)) }}"
