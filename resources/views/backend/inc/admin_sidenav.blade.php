                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                             ...
                             <li class="aiz-side-nav-item">
                                <a href="{{route('bonus_products.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['bonus_products.index', 'bonus_products.create', 'bonus_products.edit']) }}" >
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        @endif
                            @if(Auth::user()->user_type == 'admin')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('one_click_orders.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['one_click_orders.index'])}}">
                            ...
                            @if(Auth::user()->user_type == 'admin')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('indend.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['indend.index'])}}">
                ...
                @endif
                 ...
                 @if(Auth::user()->user_type == 'admin')
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('monthly_payment.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['monthly_payment.index', 'monthly_payment.show', 'monthly_payment.customer.edit'])}}">
