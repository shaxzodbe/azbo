            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('2', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('bonus_products.index')}}"
                                   class="aiz-side-nav-link {{ areActiveRoutes(['bonus_products.index', 'bonus_products.create', 'bonus_products.edit']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Bonus Product') }}</span>
                                </a>
                            </li>
                            <!--end bonus product li -->
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('Bulk_Product_Price.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Bulk Product Price') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('colors.index')}}"
                                   class="aiz-side-nav-link {{ areActiveRoutes(['colors.index', 'colors.create', 'colors.edit'])}}">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        @if(Auth::user()->user_type == 'admin')
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('one_click_orders.index') }}"
                                   class="aiz-side-nav-link {{ areActiveRoutes(['one_click_orders.index'])}}">
                        ...
                        @if(Auth::user()->user_type == 'admin')
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('indend.index') }}"
                                   class="aiz-side-nav-link {{ areActiveRoutes(['indend.index'])}}">
                        ...
                        @if(Auth::user()->user_type == 'admin')
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('uzum.index') }}"
                                   class="aiz-side-nav-link {{ areActiveRoutes(['uzum.index'])}}">
                ...
                @if(Auth::user()->user_type == 'admin')
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <i class="las la-user-friends aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ translate('Monthly Payment') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>

                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('monthly_payment.index') }}"
                                   class="aiz-side-nav-link {{ areActiveRoutes(['monthly_payment.index', 'monthly_payment.show', 'monthly_payment.customer.edit'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('Payment List') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
