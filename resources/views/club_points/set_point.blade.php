                        ...
                        <tbody>
                            @foreach($products as $key => $product)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('product', $product->slug) }}" target="_blank" class="media-block">
                                            <div class="media-left">
                                                <img loading="lazy"  class="img-md w-50px" src="{{ asset($product->thumbnail_img)}}" alt="Image">
                                            </div>
                                    ...
                                    <td>
                                        <a href="{{route('product_club_point.edit', encrypt($product->id))}}" class="btn btn-soft-primary btn-icon btn-circle btn-sm">
