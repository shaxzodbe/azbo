                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($club_point->convert_status == 0)
                                                            <button onclick="convert_point({{ $club_point->id }})" class="btn btn-sm  btn-styled btn-base-1 btn-primary">{{__('Convert Now')}}</button>
                                                        @else
                                                            <span class="badge badge-inline badge-success" style="color:white"><strong>{{ __('Done') }}</strong></span>
                                                        @endif
                                                    </td>
                                                </tr>
                                            @endforeach
